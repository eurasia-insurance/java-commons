...
public class MyCollectionsTest {
	...
	final Map<String, String> m8 = MyMaps.of("a", "a1", "b", "b1", "c", "c1", "d", "d1", "e", "e1", "f", "f1", "g",
		"g1",
		"h", "h1");
	...
	final Map<String, String> m9 = MyMaps.of("a", "a1", "b", "b1", "c", "c1", "d", "d1", "e", "e1", "f", "f1", "g",
		"g1",
		"h", "h1", "i", "i1");
	...
	final Map<String, String> m10 = MyMaps.of("a", "a1", "b", "b1", "c", "c1", "d", "d1", "e", "e1", "f", "f1", "g",
		"g1",
		"h", "h1", "i", "i1", "j", "j1");
	...
	final Map<String, String> mN = MyMaps.ofEntries(
		MyMaps.entry("a", "a1"),
		MyMaps.entry("b", "b1"),
		MyMaps.entry("c", "c1"),
		MyMaps.entry("d", "d1"),
	...
	expectException(() -> MyCollections.requireNonNullElements(NULL_ELEMENTS, "par"),
		IllegalArgumentException.class);
	expectException(() -> MyCollections.requireNullElements(NON_NULL_ELEMENTS), IllegalArgumentException.class);
	expectException(() -> MyCollections.requireNullElements(NON_NULL_ELEMENTS, "par"),
		IllegalArgumentException.class);
    }
}
